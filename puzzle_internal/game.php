...
$query = $conn->prepare("SELECT played FROM scores WHERE user_id = ?");
$query->bind_param("i", $user_id);
$query->execute();
$result = $query->get_result();
...
@keyframes heartbeat {
    ...
    <body>
        <div class="container">
            <div class="image-section">
                <img src="images/holi-small.jpg" alt="Game Over">
            </div>
            <div class="message-section">
                <h2>⚠ You have already played the game!</h2>
    ...
    header("refresh:10;url=logout.php"); // Auto logout after 2 seconds
    exit();
}
...
<body>
    ...
    <div class="container" style="display: flex;">
        ...
        <?php echo "<h3>Welcome, $name</h3><br>"; ?>
            <span id="timer-icon">⏳</span>
            <span id="timer" style="color:red;">10:00</span>
        </div>
        <a href="logout.php" class="button large" style="position: absolute; bottom: 20px; left: 50%; transform: translateX(-50%);">Logout</a>
    </div>
...
<footer class="footer">
    <p>🎨 Happy Holi | Puzzle Game 🎉 | Made with <i class="fas fa-heart"></i> &nbsp;By 404 Developer Not Found</p>
</footer>
</body>
